...
public class InicializadorDB implements ServletContextListener {
    ...
    private static final String PASS = "123456"; // Cambiar si la clave de tu compañero es distinta
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        try {
            ...
            try (Connection conFarma = DriverManager.getConnection(URL_FARMAEDU, USER, PASS);
                ...
                if (!tablasExisten) {
                    ...
                    if (is != null) {
                        ...
                        // (?i) hace que ignore mayúsculas/minúsculas, \\b asegura que sea la palabra exacta
            ...
            System.out.println("[ERROR CRÍTICO] Fallo en la inicialización: " + e.getMessage());
        }
        System.out.println("=====================================================");
    }
